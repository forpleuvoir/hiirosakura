        ...
        TableConfigMapWrappedButton(
            ...
            hoverTableScope = {
                Header {
                    ...
                    Text(InlineStyleText(it.key), modifier = Modifier.align(Alignment.CenterLeft))
                }
                Header {
                    Text(HSLang.autoReplantMapEntryReplantItem)
                }.Column {
            ...
            TableConfigMapStringKeyColumn(
                ...
                header = {
                    ...
                    Text(InlineStyleText(k), modifier = Modifier.maxWidth(120f))
                }
            )
            ...
            BlockInfoMatcherTableColumn(
                ...
                Text(matcherTableName, setting = TextSetting().copy(horizontalAlignment = Alignment.CenterHorizontally), modifier = Modifier.minWidth(120f))
            }
