...
fun ContainerScope.ConfigStringItemStackBlockInfoPairMapWrapper(
            ...
            hoverContent = {
                Table(
                    ...
                    Header {
                        ...
                        Text(InlineStyleText(it.key), modifier = Modifier.align(Alignment.CenterLeft).minWidth(20f).maxWidth(100f))
                    }

                    Header {
                        Text(HSLang.handheldItem)
                    }.Column {
                        ItemStackMatcherSimpleInfo(it.value.item, Modifier.height(10f).align(Alignment.CenterLeft))
                    }

                    Header {
                        Text(HSLang.targetBlock)
                    }.Column {
