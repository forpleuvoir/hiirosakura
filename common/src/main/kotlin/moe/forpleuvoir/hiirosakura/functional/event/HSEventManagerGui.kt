...
fun ContainerScope.HSEventManagerGui(
    ...
    Row(
        ...
        Button {
            Text(IGLang.add)
            click {
                EventSubscriberEditor(HSEventSubscriber.empty.apply {
                    if (selectedEvent.getValue() != Event::class) eventType = selectedEvent.getValue()
                }) {
...
fun EventSubscriberEditor(
    ...
    return Dialog(
        ...
        //title
        Text(HSLang.eventSubscriberEditor)
