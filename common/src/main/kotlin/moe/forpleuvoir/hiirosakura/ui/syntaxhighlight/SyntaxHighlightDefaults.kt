...
object SyntaxHighlightDefaults {
    ...
    val lightTheme: SyntaxHighlightTheme = SyntaxHighlightTheme(
        ...
        styles = mapOf(
            SyntaxToken.Keyword to SpanStyle(color = Color(0xFF8250DF)),
            SyntaxToken.Identifier to SpanStyle(color = Color(0xFF116329)),
            SyntaxToken.Type to SpanStyle(color = Color(0xFF953800)),
            SyntaxToken.Function to SpanStyle(color = Color(0xFF0550AE)),
            ...
            SyntaxToken.EscapeSequence to SpanStyle(color = Color(0xFFCF222E)),
            SyntaxToken.Comment to SpanStyle(color = Color(0xFF57606A)),
            SyntaxToken.Documentation to SpanStyle(color = Color(0xFF57606A)),
            SyntaxToken.Annotation to SpanStyle(color = Color(0xFF953800)),
            SyntaxToken.Boolean to SpanStyle(color = Color(0xFF8250DF)),
            SyntaxToken.Null to SpanStyle(color = Color(0xFF8250DF)),
    ...
    val darkTheme: SyntaxHighlightTheme = SyntaxHighlightTheme(
        ...
        styles = mapOf(
            SyntaxToken.Keyword to SpanStyle(color = Color(0xFFD2A8FF)),
            SyntaxToken.Identifier to SpanStyle(color = Color(0xFF7EE787)),
            SyntaxToken.Type to SpanStyle(color = Color(0xFFFFA657)),
            ...
            SyntaxToken.EscapeSequence to SpanStyle(color = Color(0xFFFF7B72)),
            SyntaxToken.Comment to SpanStyle(color = Color(0xFF8B949E)),
            SyntaxToken.Documentation to SpanStyle(color = Color(0xFF8B949E)),
            SyntaxToken.Annotation to SpanStyle(color = Color(0xFFFFA657)),
